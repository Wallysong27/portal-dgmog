export default function QuemSomos() {
  return (
    <div className="px-40 py-20">
      ...
      <div className="flex flex-col gap-2 items-start justify-start h-screen ml-8">
        <p className="mb-5">
          A{" "}
        ...
        <ul className="mb-20">
          ...
          <li>
            • Integrar fontes de dados heterogêneas e complexas para facilitar a
            análise de dados;
          </li>
          <li>
            • Trabalhar em colaboração com especialistas em negócios,
            desenvolvedores de software e outros profissionais de TI para
            garantir que os resultados dos projetos de análise estejam alinhados
            com os objetivos da organização;
          </li>
          <li>
            • Continuamente aprender novas técnicas e tecnologias para se manter
            atualizado no campo em evolução da análise de dados.
          </li>
        </ul>
